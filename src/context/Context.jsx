...
export const messages = {
  ...
  imagen: {
    ...
    patternMismatch:
      "La Url de la imagen tiene que empezar asi https://i.ytimg.com/ y debe povenir de Youtube",
  },
  video: {
...
const GlobalContextProvider = ({ children }) => {
  ...
  useEffect(() => {
    fetch(
      "https://my-json-server.typicode.com/LuisGLIX/Alura-Flix-Database/categorias"
    )
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(
      "https://my-json-server.typicode.com/LuisGLIX/Alura-Flix-Database/videos"
    )
      .then((res) => res.json())
  ...
  const deleteVideo = (id) => {
    fetch(
      `https://my-json-server.typicode.com/LuisGLIX/Alura-Flix-Database/videos/${id}`,
      { method: "DELETE" }
    )
      .then((res) => {
        if (!res.ok) {
